  ...
  return (
    <>
      <div className='flex flex-col items-center mt-20 mx-auto'>
        <h1 className='font-bold text-2xl text-primary text-center mb-4'>How hopePulse Works?</h1>
        <p className='text-md mb-6 text-grayish w-5/6'><span className="text-xl"> Welcome to Hopepulse, </span>the ultimate destination for rallying support for what truly matters to you! Hopepulse is the perfect platform to rally support for whatever moves you, whether you're an individual, group, or organization. Launch your fundraising campaign in minutes and watch your community come together to make a difference.</p>
      </div>
